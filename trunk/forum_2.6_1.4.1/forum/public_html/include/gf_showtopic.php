    ...
    if ($mode != 'preview') {
        if ($is_lockedtopic == 0) {
            ...
            if ($is_readonly == 0 OR forum_modPermission($showtopic['forum'],$_USER['uid'],'mod_edit')) {
                ...
                $quotelinkimg = '<img src="'.gf_getImage('quote').'" border="0" align="absmiddle" alt="'.$LANG_GF01['QUOTEICON'].'" TITLE="'.$LANG_GF01['QUOTEICON'].'">';
        ...
        if($showtopic['uid'] > 1 && $uservalid) {
            ...
            $profile_linkimg = '<img src="'.gf_getImage('profile').'" border="0" align="absmiddle" alt="'.$LANG_GF01['ProfileLink'].'" TITLE="'.$LANG_GF01['ProfileLink'].'">';
            ...
            if ($CONF_FORUM['use_pm_plugin']) {
                ...
                if ($pmplugin_link != '') {
                    ...
                    $pm_linkimg = '<img src="'.gf_getImage('pm').'" border="0" align="absmiddle" alt="'.$LANG_GF01['PMLink'].'" TITLE="'.$LANG_GF01['PMLink'].'">';
        ...
        if($userarray['email'] != '' && $showtopic["uid"] > 1) {
            ...
            $email_linkimg = '<img src="'.gf_getImage('email').'" border="0" align="absmiddle" alt="'.$LANG_GF01['EmailLink'].'" TITLE="'.$LANG_GF01['EmailLink'].'">';
        ...
        if($userarray['homepage'] != '') {
            ...
            $homepageimg = '<img src="'.gf_getImage('website').'" border="0" align="absmiddle" alt="'.$LANG_GF01['WebsiteLink'].'" TITLE="'.$LANG_GF01['WebsiteLink'].'">';
