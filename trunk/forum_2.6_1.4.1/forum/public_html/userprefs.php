...
if(isset($_POST['submit'])) {
  ...
  echo COM_startBlock($LANG_GF00['useradmintitle']);
  echo '<br><p>';
...
$navbarMenu = array(
    $LANG_GF07['1']   => $_CONF['site_url'] .'/forum/index.php',
    $LANG_GF07['2']   => $_CONF['site_url'] .'/forum/userprefs.php',
    $LANG_GF07['3']   => $_CONF['site_url'] .'/forum/index.php?op=popular',
    $LANG_GF07['4']   => $_CONF['site_url'] .'/forum/notify.php',
    $LANG_GF07['5']   => $_CONF['site_url'] .'/forum/memberlist.php'
);
