...
require_once ($_CONF['path'] . 'plugins/nexform/functions.inc');

// Plugin information
$pi_display_name = 'nexform';
$pi_name         = 'nexform';
...
$FEATURES = array();
$FEATURES['nexform.edit']       = 'Administrative access to ' . $pi_display_name;

$MAPPINGS = array();
$MAPPINGS['nexform.edit']         = array ($pi_admin);
