...
$screen = COM_applyFilter($_REQUEST['screen']);
...
switch ($mode){
    ...
    case 'filter':  //this function exists, but it is disabled for now as setting the cookie in PHP was causing a 1-click-behind issue with the filter
        //prj_setFilter($id);
        break;
}

if($screen=='myprojects'){
