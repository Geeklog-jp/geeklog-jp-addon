...
if ($_REQUEST['preview'] == $LANG_GF01['PREVIEW']) {
    ...
    $preview_header->set_var ('startblock', COM_startBlock('<b>' . $LANG_GF01['TopicPreview']
                            . '</b>','', $CONF_FORUM['path_layout'] . 'forum/layout/blockheader.thtml') );
            ...
            if ($CONF_FORUM['pre2.5_mode'] == true ) {
                if ( $quotearray['postmode'] == 'html' || $quotearray['postmode'] == 'HTML' ) {
                    if (!class_exists('StringParser') ) {
                        require_once ($_CONF['path'] . 'plugins/forum/include/bbcode/stringparser_bbcode.class.php');
                    }
