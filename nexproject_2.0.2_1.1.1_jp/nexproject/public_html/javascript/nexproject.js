  ...
  WM_netscapeCssFixCheckIn();
    ...
    function showHideModule(divID, theme) {
        ...
        if(w3c) {
            ...
            if(divIDobj != null && tlobj != null && toggleobj != null) {
                ...
                ok=true;
                if(state=="c") {
                    tlobj.src = "../layout/"+theme+"/images/spacer.gif";
                    toggleobj.src = "../layout/"+theme+"/images/module_toggle_closed.gif";
                    divIDobj.style.display = "none";
                } else {
                    tlobj.src = "../layout/"+theme+"/images/spacer.gif";
                    toggleobj.src = "../layout/"+theme+"/images/module_toggle_open.gif";
    ...
    function MM_toggleItem(form, itemName, imageName, theme) {
        ...
        if (MM_arrayContainsString(form.selectedItems, itemName)) {
            ...
            document[imageName].src = '../layout/'+theme+'/images/checkbox_off_16.gif';
        } else {
            form.selectedItems[form.selectedItems.length] = itemName;
            document[imageName].src = '../layout/'+theme+'/images/checkbox_on_16.gif';
        }
        ...
        if (form.checkboxes) {
            ...
            for (i = 0; i < checkboxCount; i++) {
                ...
                if (-1 == document[checkbox.mImageName].src.indexOf('dim_16.gif')) {
                    document[checkbox.mImageName].src = '../layout/'+theme+'/images/checkbox_on_16.gif';
    ...
    function MM_deselectAllItems(form, theme) {
        ...
        if (form.checkboxes) {
            ...
            for (i = 0; i < checkboxCount; i++) {
                var checkbox = form.checkboxes[i];
                if (-1 == document[checkbox.mImageName].src.indexOf('dim_16.gif')) {
                    document[checkbox.mImageName].src = '../layout/'+theme+'/images/checkbox_off_16.gif';
                }
            }
        }
...
function prj_ascdesc(){
    var x=readCookie('prj_ascdesc');
    if(x==' ASC '){
        setCookie('prj_ascdesc',' DESC ');
        }
    else{
        setCookie('prj_ascdesc',' ASC ');
        }
